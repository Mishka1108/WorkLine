...
export class HowItWorksComponent {
  ...
  companySteps = [
    ...
    },
    {
      ...
      tag: 'მესამე ნაბიჯი',
      title: 'კადრი მუშაობს',
      desc: 'კანდიდატი გამოდის შეთანხმებულ დღეს. ანგარიშსწორება WorkLine-ის გავლით.',
  ...
  workerSteps = [
    ...
    { num: '02', icon: '🔍', title: 'სკრინინგი',           desc: 'WorkLine ამოწმებს პროფილს და საჭიროებისას გირეკავს.',      time: '24–48 სთ'       },
    { num: '03', icon: '🔔', title: 'შეთავაზება',          desc: 'SMS ან WhatsApp — სად, ანაზღაურება, ვადა. შენ გადაწყვეტ.', time: 'დაუყოვნებლივ'  },
    { num: '04', icon: '💰', title: 'ანაზღაურება',         desc: 'სამუშაოს შემდეგ — პირდაპირ WorkLine-ის მეშვეობით.',       time: 'სამუშ. ბოლოს'  },
  ];
  ...
  faqs = [
    ...
    { q: 'შემიძლია კადრი გრძელვადიანად შევინარჩუნო?',     a: 'დიახ. სამუშაო პერიოდის შემდეგ კომპანია და კადრი შეიძლება პირდაპირ შეთანხმდნენ სრულ განაკვეთზე. WorkLine ამ პროცესს ხელს უწყობს.' },
    ...
    { q: 'კადრად დარეგისტრირება ფასიანია?',                a: 'არა. კადრებისთვის რეგისტრაცია სრულიად უფასოა. WorkLine კომპანიებისგან იღებს საკომისიოს.' },
    { q: 'როგორ ხდება ანგარიშსწორება?',                    a: 'სამუშაო პერიოდის ბოლოს WorkLine გიგზავნის ინვოისს. გადახდა ხდება საბანკო გადარიცხვით. ყველა დეტალი წინასწარ შეთანხმებულია.' },
  ];
