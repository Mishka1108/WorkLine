...
export class CandidatesComponent {
  ...
  steps = [
    ...
    },
    {
      num: '02',
      title: 'ჩვენ ვარჩევთ',
      desc: 'WorkLine-ი შეარჩევს შენთვის შესაფერის პოზიციას — გამოცდილება, ადგილი, გრაფიკი.',
    },
    {
      num: '03',
    ...
    },
    {
      ...
      desc: 'WorkLine-ის მეშვეობით — პირდაპირ, გამჭვირვალედ, დროზე. არანაირი გაუგებრობა.',
    },
  ];
  ...
  testimonials = [
    ...
    {
      text: 'სტუდენტი ვარ და ძალიან მიხდება, რომ გრაფიკი თვითონ ვარჩევ. WorkLine-მა სემესტრის პარალელურად ანაზღაურება მაძლია.',
      name: 'ანი ც.',
      role: 'კადრი — კაფე',
      initials: 'ა',
      color: '#8b4a6b',
    ...
    {
      text: 'პირველი სამუშაო ეს იყო ახალ ქალაქში. WorkLine-მა ყველაფერი ახსნა, თან ახლო სახლთან მიპოვა ადგილი. ძალიან კომფორტული.',
      name: 'ლევან კ.',
      role: 'კადრი — საწყობი',
      initials: 'ლ',
      color: '#2a5a8a',
